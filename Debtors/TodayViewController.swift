...
class TodayViewController: UIViewController, NCWidgetProviding {
    ...
    override func viewDidLoad() {
        ...
        config.fileURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.hdfcbank.moneycollect")!.appendingPathComponent("default.realm")
...
extension TodayViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        formatter.currencySymbol = UserDefaults(suiteName: "group.hdfcbank.moneycollect")?.string(forKey: "currencySymbol")
